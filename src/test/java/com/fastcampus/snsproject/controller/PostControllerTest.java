...
public class PostControllerTest {
    ...
    @Test
    @WithAnonymousUser
    void 포스트_작성시_로그인하지않은경우() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 포스트_수정시_로그인하지않은경우() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 내_피드_목록_요청시_로그인하지_않은_경우() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 좋아요_버튼_클릭_시_로그인하지_않은_경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 좋아요_버튼_클릭_시_게시물이_없는_경우() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 댓글_작성_시_로그인하지_않은_경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 댓글_작성_시_게시물이_없는_경우() throws Exception {
